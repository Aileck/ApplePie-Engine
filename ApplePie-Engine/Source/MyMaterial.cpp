...
void MyMaterial::LoadMaterial(const tinygltf::Model& model, const tinygltf::Material& material)
{
        ...
        if (extensionMap.Has("diffuseTexture")) {
            ...
            if (diffuseTexture.IsObject()) {
                ...
                if (indexValue.IsInt()) {
                    ...
                    MyTexture* diffuseTexture = new MyTexture();
        ...
        if (extensionMap.Has("specularGlossinessTexture")) {
            ...
            if (specularGlossinessTexture.IsObject()) {
                ...
                if (indexValue.IsInt()) {
                    ...
                    MyTexture* specularTexture = new MyTexture();
