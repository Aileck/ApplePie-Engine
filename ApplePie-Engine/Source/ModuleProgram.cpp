...
bool ModuleProgram::Init() {
	...
	const char* VerteixShaderFile = FileComponent::CreateFilePath(SHADER_PATH, "phongvs.glsl");
	const char* FragmentShaderFile = FileComponent::CreateFilePath(SHADER_PATH, "phongfs.glsl");
